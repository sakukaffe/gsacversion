-- Locales
GS_AC.IsAdmin = false -- DON'T TOUCH THIS
...
-- MENU 2
local menu2 = MenuV:CreateMenu(false, "GS-AC Admin Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'GS-AC: Admin Menu')
...
-- MENU 3
local menu3 = MenuV:CreateMenu(false, "GS-AC: Connected Players", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'GS-AC: Connected Players')
...
-- MENU 4
local menu4 = MenuV:CreateMenu(false, "GS-AC Server Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'GS-AC: Server Tools')
...
-- MENU 5
local menu5 = MenuV:CreateMenu(false, "GS-AC Teleport Options", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'GS-AC: Teleport Options')
...
-- MENU 6
local menu6 = MenuV:CreateMenu(false, "GS-AC Vehicle Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'GS-AC: Vehicle Tools')
...
-- MENU 7
local menu7 = MenuV:CreateMenu(false, "GS-AC Admin Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'GS-AC: TP Tools Tools')
local menu7_acinfo = menu7:AddButton({ icon = 'ℹ️', label = 'AntiCheat Version: 1.1', description = 'dsc.gg/rinov' })
local menu7_creatorac = menu7:AddButton({ icon = 'ℹ️', label = 'GS-AC by Gaming_heart#1754', description = 'dsc.gg/rinov' })
...
-- PRINCIPAL MENU
local menu = MenuV:CreateMenu(false, "Welcome to GS-AC's Admin Menu", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'GS-AC: Main Menu')
...
RegisterCommand('gsacmenu', function()
    if GS_AC.IsAdmin then
        menu:Open()
    end
end, false)

RegisterKeyMapping('gsacmenu', "GS-AC Admin Menu", 'keyboard', 'INSERT')
